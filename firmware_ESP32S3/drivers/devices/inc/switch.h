...
/** \brief Switches driver, ported to a generic ESP32-S3 devkit.
 *
 * @note 2 switches supported: SWITCH_1 (default GPIO_4), SWITCH_2 (default GPIO_9).
