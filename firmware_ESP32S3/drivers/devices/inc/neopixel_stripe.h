 ...
 * 
 * @note The ESP32-S3 Super Mini has one onboard addressable WS2812 RGB LED wired to
 * GPIO_48 (per the board's official pinout), which is also broken out on the header
 * so it can be reused to chain external NeoPixels.
 * 
...
#include "gpio_mcu.h"
/*==================[macros]=================================================*/
#define BUILT_IN_RGB_LED_PIN          GPIO_48       /*> ESP32-S3 Super Mini onboard WS2812 RGB LED (confirmed on the board's official pinout) */
