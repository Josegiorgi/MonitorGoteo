...
/** @brief I2C driver for a generic ESP32-S3 DevKit.
 *
 * @note SDA: GPIO_5, SCL: GPIO_6 (matches the ESP32-S3 Super Mini's silkscreen-labeled
 * I2C pins).
 *
...
/*==================[typedef]================================================*/
#define I2C_MASTER_SCL_IO           GPIO_6      /*!< GPIO number used for I2C master clock */
#define I2C_MASTER_SDA_IO           GPIO_5      /*!< GPIO number used for I2C master data  */
