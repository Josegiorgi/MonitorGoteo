...
digital_io_t gpio_list[GPIO_QTY] = {
	...
	{GPIO_NUM_NC, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* GPIO22 - doesn't exist on this chip, unused placeholder (GPIOInit always rejects it) */
	{GPIO_NUM_NC, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* GPIO23 - doesn't exist on this chip, unused placeholder (GPIOInit always rejects it) */
	{GPIO_NUM_NC, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* GPIO24 - doesn't exist on this chip, unused placeholder (GPIOInit always rejects it) */
	{GPIO_NUM_NC, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* GPIO25 - doesn't exist on this chip, unused placeholder (GPIOInit always rejects it) */
	...
	{GPIO_NUM_28, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO28*/
	{GPIO_NUM_29, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO29*/
	{GPIO_NUM_30, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO30*/
	{GPIO_NUM_31, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO31*/
	...
	{GPIO_NUM_37, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO37*/
	{GPIO_NUM_38, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO38*/
	{GPIO_NUM_39, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO39*/
	{GPIO_NUM_40, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO40*/
	{GPIO_NUM_41, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO41*/
	{GPIO_NUM_42, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO42*/
	{GPIO_NUM_43, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO43*/
	{GPIO_NUM_44, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO44*/
	{GPIO_NUM_45, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO45*/
	{GPIO_NUM_46, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO46*/
	{GPIO_NUM_47, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO47*/
	{GPIO_NUM_48, GPIO_MODE_DISABLE, GPIO_PULLUP_ONLY, false}, /* Configuration GPIO48*/
};
...
void GPIOInit(gpio_t pin, io_t io){
	if(((pin >= GPIO_22) && (pin <= GPIO_32)) || (pin > GPIO_48)){
		return;
	}
	if(io == GPIO_INPUT){
